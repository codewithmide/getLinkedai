...
const Privacy:React.FC = () => {
    return (
        <div className="center w-full relative py-[6rem] overflow-hidden">
            <div className="w-[85%] between z-50">
                <div className="w-[48%] center p-10">
                    <div className="w-full flex flex-col">
                        <div className="flex flex-col gap-3 mt-10">
                            ...
                            <p className="text-sm update">
                                Last updated on September 12, 2023
                            </p>
                            <p className="w-[438px] leading-[26px] text-sm mt-10">
                                Below are our privacy & policy, which outline a lot of goodies. it’s our aim to always take of our participant
                            </p>
                        </div>
                        <div className="privacy center flex-col px-16 py-10 mt-10">
                            <p className="text-sm leading-[30.296px]">
                            ...
                            <div className="start flex-col w-full my-10">
                                <h3 className="font-bold text-purple leading-[34px]">
                                    Licensing Policy
                                </h3>
                                <p className="text-sm fontb#">
                                    Here are terms of our Standard License:
                                </p>
                            </div>
                            <div className="w-full between gap-6">
                                <div className="flex items-start justify-start h-full">
                                    <img src="/svgs/listTerms.svg" alt="list" className="w-[25px]"/>
                                </div>
                                <div className="text-sm">
                                    The Standard License grants you a non-exclusive right to navigate and register for our event
                                </div>
                            </div>
                            <div className="w-full between gap-6 mt-6">
                                <div className="flex items-start justify-start h-full">
                                    <img src="/svgs/listTerms.svg" alt="list" className="w-[25px]"/>
                                </div>
                                <div className="text-sm">
                ...
                <div className="w-[48%] center mt-[10rem]">
            ...
            <div className="absolute left-0 -bottom-[30rem]">
                <img src="/images/privacyFlare.png" alt="purple flare" className="purpleFlare1" />
            </div>
            <div className="absolute right-[6rem] top-[6.5rem] ">
                <img src="/images/shield.png" alt="purple flare" className="purpleFlare1" />
            </div>
            <div className="absolute bottom-[20%] left-[5%]">
                <img src="/images/prizeStarTL.png" alt="purple flare" className="purpleFlare1" />
            </div>
            <div className="absolute left-[35%] top-[13%]">
                <img src="/images/privacyStarTL.png" alt="purple flare" className="purpleFlare1" />
            </div>
            <div className="absolute top-[20%]">
                <img src="/images/privacyStarM3.png" alt="purple flare" className="purpleFlare1" />
            </div>
            <div className="absolute top-[20%] right-[15rem]">
                <img src="/images/privacyStaTR.png" alt="purple flare" className="purpleFlare1" />
            </div>
            <div className="absolute bottom-[27%] right-[5%]">
                <img src="/images/privacyStarLR.png" alt="purple flare" className="purpleFlare1" />
            </div>
            <div className="absolute bottom-[30%] right-[34rem]">
                <img src="/images/privacyStarM.png" alt="purple flare" className="purpleFlare1" />
            </div>
            <div className="absolute bottom-[26rem] right-[30rem]">
                <img src="/images/privacyStarM2.png" alt="purple flare" className="purpleFlare1" />
            </div>
        </div>
    );
}
